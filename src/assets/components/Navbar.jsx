...
const Navbar = () => {
  ...
  return (
    <div
      className={`w-full py-5 relative z-50 text- px-3 md:px-5  ${
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          <ul className="flex items-start gap-10 lg:gap-20 font-medium ">
            ...
            {/* Menu */}
            <li>
              <button onClick={menuOpen} className="cursor-pointer">
                <CiMenuFries
                  size={18}
            ...
            <li>
              <button onClick={cartOpen} className="cursor-pointer">
                <FaOpencart
                  size={18}
                  className={`transition-all duration-300 transform ${
                    closeCart
              ...
              >
                <div className=" pt-40 w-full  relative ">
                  ...
                  <div className="bg-black max-w-dvw  py-2 md:py-5 border-2 border-x-0 flex  border-b-0  overflow-hidden gap-20">
                    <div
                      ref={empty1}
